...
export default function KelasForm({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <DialogTitle>
        {editData ? `Kelas — ${editData.nama}` : "Tambah Kelas"}
      </DialogTitle>
      <form onSubmit={handleSubmit(onSubmit)}>
        <DialogContent>
          ...
          <TextField
            ...
            helperText={errors.mata_pelajaran?.message}
          />
          <TextField
            label="Deskripsi"
            fullWidth
          ...
          <TextField
            ...
            helperText={errors.kapasitas?.message}
          />
          <TextField
